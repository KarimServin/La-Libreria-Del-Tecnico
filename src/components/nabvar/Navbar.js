...
export const NavbarFunction = () => {
   ...
   <Navbar expand="lg">
   <Container fluid>
     <Navbar.Brand href="#"><Link to='/' style={{ textDecoration: 'none', color: 'black' }}>
     <span role="img" aria-label='emoji del librito'>&#128218;</span> La Librería del Técnico</Link> </Navbar.Brand> 
     <Navbar.Toggle />
